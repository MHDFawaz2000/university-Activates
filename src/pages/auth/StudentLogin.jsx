      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          <div className="flex justify-between items-center mb-8">
            <Link to="/" className="inline-flex items-center text-green-600 hover:text-green-700">
              <ArrowLeft className={`h-5 w-5 ${isRTL ? 'rotate-180' : ''} ${isRTL ? 'ml-2' : 'mr-2'}`} />
              {t('home')}
            </Link>
            <LanguageSwitcher />
          </div>
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-2">{t('studentLoginTitle')}</h2>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex items-start">
            ...
            <div>
              <h4 className="font-medium text-blue-900">First time using the platform?</h4>
              <p className="text-sm text-blue-700 mt-1">
                Use your official 9-digit student ID provided by the university registrar.
              </p>
            </div>
          </div>
        </div>
